...
**Experiencing LeetCode fatigue? Learn these 14 patterns and you’ll have a more complete picture 
of how to approach a problem no matter the question.**  
...
question — so they don’t have to worry about solving hundreds of problems and suffer from 
Leetcode fatigue. If you understand the generic patterns, you can use them as a template 
to solve a myriad of other problems with slight variations.
...
The following patterns assume that you’ve brushed up on Data Structures. If you haven’t, check out 
these refresher courses on [Data Structures](https://github.com/AmitVardhan/GrokkingCodingInterview).
...
TODO: image sliding window link
...
TODO: image for fast and slow pointers
...
Decide whether to process the current node now (pre-order), or between processing two children (in-order) 
...
Iterate through the remaining numbers and if you find one that is larger than what you have in the heap, then 
